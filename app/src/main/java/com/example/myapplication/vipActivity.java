...
public class vipActivity extends MainActivity implements View.OnClickListener{
    MyHelper myHelper;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myHelper = new  vipActivity.MyHelper(this);
        init();
    }
    //实例化界面，获取各个控件的值
    private void init() {
    ...
    public void updateText() {
        ...
        values = new ContentValues();
        //主键 id  改变名字价格
        price = mEtEmail.getText().toString();
        c = Integer.valueOf(price);
        d = (c/b)*a;
        e = Integer.toString(d);
        values.put("phone",phone = mEtPhone.getText().toString());
        values.put("email",email = e);
        //更新并得到行数
